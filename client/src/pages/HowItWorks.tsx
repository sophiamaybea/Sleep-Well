      ...
      <main className="relative z-10">
        ...
        <section className="py-24 px-6 md:px-12 border-t border-white/[0.04]" data-testid="section-features">
          <div className="max-w-5xl mx-auto space-y-16">
            ...
            {[
              {
                name: "Seeding (Private Drafts)",
                tagline: "This is your private workspace. No one else can see what you write here.",
                icon: <Sprout className="w-8 h-8" />,
                color: "text-emerald-400",
                borderColor: "border-emerald-400/15",
                description: "Think of 'Seeding' as your private notebook. It is a locked door. Use this space to write your first ideas, messy drafts, and personal thoughts. You decide if and when anyone else ever sees them.",
                howToLabel: "How to use it",
                howTo: [
                  "Go to 'The Soil' (Seeding) to start a new piece of writing",
                  "Click 'New Piece' to open a blank page and start typing",
                  "Everything you save here stays private by default",
                  "If you want others to read it, you can 'move it to Sunlight' later",
                ],
              },
              {
                name: "Sunlight (Public Reading)",
                tagline: "This is where you share your work and read what others have written.",
                icon: <Sun className="w-8 h-8" />,
                color: "text-amber-400",
                borderColor: "border-amber-400/15",
                description: "'Sunlight' is the public part of the site. When you move a story or poem here, other writers can read it and leave nice comments. It is also where you go to find interesting things to read from the community.",
                howToLabel: "How to use it",
                howTo: [
                  "Visit the 'Reading Room' (Sunlight) to see what others are writing",
                  "To share your work, change a piece's setting from 'Private' to 'Public'",
                  "You can leave 'Resonance' (like a 'Like' button) on things you enjoy",
                  "Check the 'Garden Feed' to see the very latest posts",
                ],
              },
              {
                name: "Nutrients (Writing Practice)",
                tagline: "This is where you go to get better at writing with exercises.",
                icon: <Leaf className="w-8 h-8" />,
                color: "text-teal-400",
                borderColor: "border-teal-400/15",
                description: "'Nutrients' are tools to help your writing grow. We provide daily prompts (ideas to write about), writing 'rituals' to help you build a habit, and small groups called 'Circles' where you can talk to other writers.",
                howToLabel: "How to use it",
                howTo: [
              ...
              {
                name: "Greenhouse (Professional Tools)",
                tagline: "This is for writers who want to get published or take classes.",
                icon: <GraduationCap className="w-8 h-8" />,
                color: "text-violet-400",
                borderColor: "border-violet-400/15",
                description: "The 'Greenhouse' is for serious growth. Here you can find 'Courses' (online classes), a 'Submission Tracker' (to keep track of where you sent your work), and 'Editorial Feedback' where a real person reads your work and gives you advice.",
