...
- **Editorial Studio:** A dedicated `/editor-studio` page with six tabs (Overview, Garden Stream, Greenhouse, Requests & Contracts, Issue Builder, Flagged Queue) for a comprehensive editorial workflow, including role-based permissions, publish request management, issue assembly, and editorial flag response queue with paid-flag priority sorting.
